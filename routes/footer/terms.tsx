export default function TermsPage() {
    return (<div style="margin-right:auto;margin-left:auto; width: 1000px;">
        <p>Terms of Use</p>
        ...
        <p>These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf
            of an entity (“you”) and The Writing Desk, LLC (“<strong>Company</strong>,” “<strong>we</strong>,”
            “<strong>us</strong>,” “<strong>our</strong>”), concerning your access to and use of the <a
                style="text-decoration: underline !important; color:blue !important"
                href="www.usethewritingdesk.com">www.usethewritingdesk.com</a> website as well as any other media form,
            media channel, mobile website, or mobile application related, linked, or otherwise connected thereto
            (collectively, the “Site). We are registered in Ohio, United States and have our registered office at 6546
            Market Ave. North, STE 100, North Canton, OH 44721. You agree that by accessing the Site you have read,
        ...
        <p>The information provided on the Site is not intended for distribution to our use by any person or entity in
        ...
        <p>The Site is not tailored to comply with industry-specific regulations (Health Insurance Portability and
            Accountability Act (HIPAA), Federal Information Security Management Act (FISMA), etc.), so if your
            interactions would be subject to such laws, you may not use this Site. You may not use the Site in a way
            that would violate the Gramm-Leach-Billey Act (GLBA). </p>

        <p>The Site is intended for users who are at least 18 years old. Persons under the age of 18 are not permitted
            to use or register for the Site. </p>
        ...
        <ul>
            ...
            <li>Disparate, tarnish, or otherwise harm, in our opinion, us and/or the Site.</li>
            ...
            <li>Except as permitted by law, decipher, decompile, disassemble, or reverse engineer any of the software
        ...
        <ul>
            ...
            <li>You are the creator and owner of or have the necessary licenses, rights, consents, releases, and
                permissions to use and authorize us, the Site, and other users of the Site to use your Contributions in
        ...
        <p>Any use of the Site in violation of the foregoing violates these Terms of Use and may result in, among other
            things, termination of suspension of your rights to use the Site. </p>
        <h1>6. Contribution License</h1>
        <p>You agree that we may access, store, process, and use any information and personal data that you provide
        ...
        <h1>8. Third-Party Website and Content</h1>
        ...
        <p>We care about data privacy and security. Please review our Privacy Policy. By using the Site, you agree to be
            ...
            States, and you agree to have your data transferred to and processed in the United States. </p>
        ...
        <h1>12. Modifications and Interruptions</h1>
        ...
        <p>These Terms of Use and your use of the Site are governed by and construed in accordance with the laws of the
            State of Ohio and applicable to agreements made and to be entirely performed within the State of Ohio,
        ...
        <p>If the Parties are unable to resolve a Dispute through informal negotiations, the Dispute (except those
            ...
            Related Disputes (“AAA Consumer Rules”), both which are available at the AAA website: <a
                style="text-decoration: underline !important; color:blue !important"
                href="www.usethewritingdesk.com">www.adr.org</a>. Your arbitration fees and your share of arbitrator
            compensation shall be governed by the AAA Consumer Rules and, where appropriate, limited by the AAA Consumer
            Rules. If such costs are determined by the arbitrator to be excessive, we will pay all arbitration fees and
            ...
            the arbitration will take place in Hancock, Ohio. Except as provided herein, the Parties may litigate in
        ...
        <p>If for any reason, a Dispute proceeds in court rather than arbitration, the Dispute shall be commenced or
            prosecuted in the state and federal courts located in Hancock, Ohio, and the Parties hereby consent to, and
            ...
            the International Sale of Goods and the Uniform Computer Information Transaction Act (UCITA) is excluded
            from these Terms of Use. </p>

        <p>In no event shall any Dispute brought by either Party related in any way to the Site be commenced more than
            one (1) year after the cause of arbitration arose. If this provision is found to be illegal or
            ...
            personal jurisdiction of the court. </p>
        <h2>Restrictions</h2>
        ...
        <p>The Parties agree that the following Disputes are not subject to the above provisions concerning informal
            negotiations and arbitration: (a) any Disputes seeking to enforce or protect, or concerning the validity of,
            ...
            Parties agree to submit to the personal jurisdiction of that court. </p>
        <h1>15. Corrections</h1>
        ...
        <h1>16. Disclaimer</h1>
        <p>THIS SITE IS PROVIDED ON AN AS-IS AND AS-AVAILABLE BASIS. YOU AGREE THAT YOUR USE OF THE SITE AND OUR
            ...
            RESULTING FROM YOUR ACCESS TO AND USE OF THE SITE, (3) ANY AUTHORIZED ACCESS TO OR USE OF OUR SECURE SERVERS
            AND/OR ANY AND ALL PERSONAL INFORMATION AND/OR FINANCIAL INFORMATION STORED THEREIN, (4) ANY INTERRUPTION OR
            CESSATION OF TRANSMISSION TO OR FROM THE SITE, (5) ANY BUGS, VIRUSES, TROJAN HORSES, OR THE LIKE WHICH MAY
            BE TRANSMITTED TO OR THROUGH THE SITE BY ANY THIRD PARTY, AND/OR (6) ANY ERRORS OR OMISSIONS IN ANY CONTENT
            ...
            WE WILL NOT BE A PARTY TO OR IN ANY WAY RESPONSIBLE FOR MONITORING ANY TRANSACTION BETWEEN YOU AND ANY
        ...
        <h1>17. Limitations of Liability</h1>
        ...
        <p>We will maintain certain data that you transmit to the Site for the purpose of managing the performance of
            ...
            of such data. </p>
        <h1>20. Electronic Communications, Transactions, and Signatures</h1>
        ...
        <h1>21. California Users and Residents</h1>
        <p>If any complaint with us is not satisfactorily resolved, you can contact the Complaint Assistance Unit of the
            ...
            Market Blvd., Suite N 112, Sacramento, California 95834 or by telephone at (800) 952-520 or (916)
            445-1254. </p>
        <h1>22. Miscellaneous</h1>
        ...
        <p><a href="mailto:bailey@usethewritingdesk.com">bailey@usethewritingdesk.com</a></p>
        <p>The Writing Desk, LLC</p>

        <p>These Terms of Use were created using Termly’s <a
            style="text-decoration: underline !important; color:blue !important"
            href="https://termly.io/products/terms-and-conditions-generator/">Terms and Conditions Generator</a>.</p>
    </div>);
}