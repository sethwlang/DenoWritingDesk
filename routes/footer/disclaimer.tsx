export default function DisclaimerPage() {
    return (
        ...
        <div style="margin-right:auto;margin-left:auto; width: 1000px;">
            <p>Disclaimer for The Writing Desk</p>
            <h1>Disclaimer</h1>
            ...
            <ul>
                <li><strong style="font-weight:800">Company</strong> (referred to as either "the Company", "We", "Us" or
                    "Our" in this Disclaimer)
                    refers to The Writing Desk, LLC, Registered Agents Inc. 6545 Market Ave. North STE 100 North Canton,
                    OH
                    44721.
                </li>

                <li><strong style="font-weight:800">Service</strong> refers to the Website.</li>
                <li><strong style="font-weight:800">You</strong> means the individual accessing the Service, or the
                    company, or other legal entity on
                    behalf of which such individual is accessing or using the Service, as applicable.
                </li>
                <li><strong style="font-weight:800">Website</strong> refers to The writing Desk, accessible from <a
                    style="text-decoration: underline !important; color:blue !important"
                    href="www.usethewritingdesk.com">www.usethewritingdesk.com</a></li>
            </ul>
            <h1>Disclaimer</h1>
            ...
            <p>In no event shall the Company be liable for any special, direct, indirect, consequential, or incidental
                ...
                prior notice. This Disclaimer has been created with the help of the Free Disclaimer Generator.</p>
            ...
            <p>The information given by the Service is for general guidance on matters of interest only. Even if the
                Company
                takes every precaution to ensure that the content of the Service is both current and accurate, errors
                can
            ...
            <p>The Company believes this constitutes a "fair use" of any such copyrighted material as provided for in
                section 107 of the United States Copyright law.</p>
            ...
            <p>Comments published by users are their sole responsibility and the users will take full responsibility,
                ...
                result
                of something written in a comment. The Company is not liable for any comment published by users and
                reserves
            ...
            <p>The information on the Service is provided with the understanding that the Company is not herein engaged
                in
                rendering legal, accounting, tax, or other professional advice and services. As such, it should not be
                used
                as a substitute for consultation with professional accounting, tax, legal or other competent
                advisers.</p>
            ...
            <p>All information in the Service is provided "as is", with no guarantee of completeness, accuracy,
                timeliness
                or of the results obtained from the use of this information, and without warranty of any kind, express
                or
            ...
            <p>The Company will not be liable to You or anyone else for any decision made or action taken in reliance on
                the
                information given by the Service or for any consequential, special or similar damages, even if advised
                of
                the possibility of such damages.</p>
            <h1>Contact Us</h1>
            <p>If you have any questions about this Disclaimer, You can contact Us:</p>
            <ul>
                <li>By email: <a href="mailto:bailey@usethewritingdesk.com">bailey@usethewritingdesk.com</a></li>
            </ul>
